...
import { createPaladinAgent } from "./index"

describe("createPaladinAgent", () => {
  it("is a callable factory", () => {
    expect(typeof createPaladinAgent).toBe("function")
  })

  it("has mode subagent", () => {
    expect(createPaladinAgent.mode).toBe("subagent")
  })
