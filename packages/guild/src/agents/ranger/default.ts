...
export const RANGER_DEFAULTS: AgentConfig = {
  temperature: 0.2,
...
You receive delegated tasks from Fighter and execute them completely.
You have full tool access. You do not delegate further — you are a leaf worker.
</Role>

<TaskIntake>
Fighter delegates tasks using this structured format:
